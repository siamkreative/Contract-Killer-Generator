...
<head>
	...
	<link class="inc_pdf" rel="stylesheet" type="text/css" href="http://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/3.3.4/css/bootstrap.min.css">
	...
	<link rel="stylesheet" type="text/css" href="app-screen-only.css">
		...
		<div id="page-content-wrapper">
			<div class="page-content">
				<div class="container">
					...
					<div id="contract">
						<!-- <img class="logo" src="img/logo_300x300.jpg" height="300" width="300" alt=""> -->
						...
						<div class="nitty">
							...
							<table id="signatures" class="table table-bordered">
								...
								<tr>
									<td>Signed by and on behalf of <span class="item name">company name</span></td>
									<td>Signed by and on behalf of <span class="item customername">customer name</span></td>
								</tr>
							</table>
